...
function HelloWorld() {
  return /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-center min-h-screen bg-blue-50" }, /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement("h1", { className: "text-4xl font-bold text-blue-600 mb-4" }, "Hello, World!"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600" }, "Welcome to the hello world app")));
}
const root$1 = document.getElementById("helloworld");
if (root$1) {
  ReactDOM.createRoot(root$1).render(
    /* @__PURE__ */ React.createElement(React.StrictMode, null, /* @__PURE__ */ React.createElement(HelloWorld, null))
  );
}
function FindTeamSchedule() {
  return /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-center min-h-screen bg-blue-50" }, /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement("h1", { className: "text-4xl font-bold text-blue-600 mb-4" }, "Hello, FindTeamSchedule!"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600" }, "Welcome to FindTeamSchedule")));
}
const root = document.getElementById("FindTeamSchedule");
if (root) {
  ReactDOM.createRoot(root).render(
    /* @__PURE__ */ React.createElement(React.StrictMode, null, /* @__PURE__ */ React.createElement(FindTeamSchedule, null))
  );
}
